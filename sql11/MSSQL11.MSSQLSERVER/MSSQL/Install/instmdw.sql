...
SET @new_value = '11.0.2100.60'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '11.0.2100.60')   -- value only used during development
    BEGIN
...
BEGIN
    ...
    BEGIN
        ...
        SELECT 
            ...
            t.object_id,
            t.object_name,
            LTRIM(SUBSTRING(t.sql_text, @start / 2 + 1, ((CASE WHEN @end = -1 THEN DATALENGTH(t.sql_text) ELSE @end END) - @start) / 2))
        FROM
